...
for file_path in tqdm(file_paths):
    ...
    file_path = osp.join(folder, f'{fileid}_solution_{args.input_id}_{pid}.py')
    ...
    outfile_name = f'/scratch/fanw6/code_contests/description_{fileid}_{pid}_gpt-4_{args.input_id}.txt'
