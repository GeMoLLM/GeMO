...
parser.add_argument('--n_probs', type=int, default=135)
parser.add_argument('--n_src', type=int, default=20)
...
# Save the arrays
np.savez(osp.join(folder, f'src_stats.npz'), outcomes=outcomes, runtimes=runtimes, memories=memories)