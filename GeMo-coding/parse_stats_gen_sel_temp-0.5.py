...
parser.add_argument('--n_probs', type=int, default=5)
...
# Save the arrays
np.savez(osp.join(folder, f'stats_{args.input_id}_sel_temp-0.5.npz'), outcomes=outcomes, runtimes=runtimes, memories=memories)