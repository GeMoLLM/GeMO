...
parser.add_argument('--input_id', type=str, default='codeonly_0')
...
for file_path in file_paths:
    ...
    filename = f'description_{fileid}_{pid}_gpt4_{args.input_id}.txt'
    with open(filename, 'r') as file:
        file_content = file.read()
        json_data = parse_file_to_json(file_content)
        json.dump(json_data, open(f'parsed_description_{fileid}_solution_{args.input_id}_{pid}.json', 'w'), indent=4)
