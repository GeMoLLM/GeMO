...
# Set the paths
python_file=${FILEID}_solution_${INPUTID}_${PID}.py

echo $python_file
stats_file="run_judge_stats/stats_${FILEID}_${PID}_gen_${INPUTID}.txt"
...
for i in {0..9}; do
    ...
    output_file="run_output/${PROBNAME}_${INPUTID}_output_$i.txt"
