...
for T in T_list:
    for P in P_list:
        input_folder = f'folder_goodreads_completions_{args.mode}_{args.model}-chat_500_temp-{T}_p-{P:.2f}_k-50'
        ...
        out_file = f'{out_folder}/wordfreq_goodreads_{args.mode}_{args.model}-chat_500_temp-{T}_p-{P:.2f}_k-50.json'
        print(out_file)
