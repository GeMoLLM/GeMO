...
out_folder = 'analysis_results_word_freq'
...
for T in T_list:
    for P in P_list:
        filepath = f'{folder}/topic_goodreads_{args.mode}_{args.model}-chat_500_temp-{T}_p-{P:.2f}_k-50.json'
...
pickle.dump(result, open(f'{out_folder}/summary_word_freq_goodreads_{args.mode}_{args.model}-chat_500.pkl', 'wb'))
