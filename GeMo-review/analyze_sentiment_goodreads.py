...
for T in T_list:
    for P in P_list:
        filepath = f'{folder}/sentiment_goodreads_{args.mode}_{args.model}-{args.chat}_500_temp-{T}_p-{P:.2f}_k-50.json'
...
pickle.dump(final_results, open(f'{out_folder}/summary_sentiment_goodreads_{args.mode}_{args.model}-{args.chat}_500.pkl', 'wb'))
