...
colors = ['#222222', '#444444', '#666666', '#888888', '#AAAAAA', '#CCCCCC'][::-1]
labels = ['[0,0.35]', '(0.35,0.55]', '(0.55,0.75]', '(0.75,0.85]', '[0.85,0.95]', '(0.95,1.00]'][::-1]
...
# Create the legend
legend = ax.legend(markers, labels, loc='center', ncol=1, frameon=False,
...
# Display the legend
plt.savefig('figs/legend_fade_demonstration.pdf', bbox_inches='tight')