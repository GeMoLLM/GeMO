...
gen_path_2 = osp.join(folder, f'summary_sentiment_goodreads_{args.mode}_llama-2-13b-nonchat_500.pkl')
...
plot_stacked_barchart(str_list, data_list, f'fig_sentiment_stacked_barchart_{args.metric}_{args.mode}_chat_cmp.pdf', shades=shades)
