...
markers = [mlines.Line2D([], [], color=color, marker='_', linestyle='-', linewidth=3) for color in colors1]
...
# Display the legend
plt.savefig('figs/fig_legend_topic_entropy_more_1.pdf', bbox_inches='tight')
...
# Create a list of rectangle markers
markers = [mlines.Line2D([], [], color=color, marker='_', linestyle='-', linewidth=3) for color in colors2]
...
# Display the legend
plt.savefig('figs/fig_legend_topic_entropy_more_2.pdf', bbox_inches='tight')