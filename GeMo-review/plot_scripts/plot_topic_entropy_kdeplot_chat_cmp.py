...
gen_path_1 = osp.join(folder, f'summary_topic_goodreads_{args.mode}_llama-2-13b-chat_500.pkl')
gen_path_2 = osp.join(folder, f'summary_topic_goodreads_{args.mode}_llama-2-13b-nonchat_500.pkl')
...
print('sent_x_src:', sent_x_src.shape)
print('sent_x_gen_1:', sent_x_gen_1.shape)
print('sent_x_gen_2:', sent_x_gen_2.shape)
...
plot_kdeplot(
    data_list,
    f'fig_topic_histplot_{args.metric}_{args.mode}_chat_cmp.pdf', 
