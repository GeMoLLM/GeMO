...
gen_path = osp.join(folder, f'summary_sentiment_goodreads_{args.mode}_{args.model}-chat_500.pkl')
...
for ti, T in enumerate(T_list):
    ...
    plot_custom_barcharts(
        data_list, 
        f'sentiment_{args.metric}_{args.mode}_{args.model}_T-{T}.pdf',
...
for pi, P in enumerate(P_list):
    ...
    plot_custom_barcharts(
        data_list, 
        f'sentiment_{args.metric}_{args.mode}_{args.model}_P-{P}.pdf',
        -0.5, 3.5, width=0.8, precision=2, xrange=0.2,
